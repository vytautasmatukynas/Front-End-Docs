...
const EventHandlingFormsSample3 = () => {
    ...
    const handleClick = () => {
        // Set the 'submitted' state to 'true' when the button is clicked
        setSubmitted(true);
    };
    ...
    return (
        <div>
            ...
            <h1>
                {submitted
                    ? `Form Submitted: ${fullName.firstName} ${fullName.lastName}`
                    : "Fill Form"}
            </h1>
            ...
            <form>
                ...
                {/* Button with 'onClick' handler to trigger the form submission */}
...
export default EventHandlingFormsSample3;
